...
Даже если наш компьютер имеет одноядерный процессор (а значит два потока никак не могут работать одновременно), потоки могут нарушить работу друг друга.
Проблема заключается в том, что потоки засыпают и просыпаются в неконтролируемые моменты времени. 
Потоки сами не решают когда им заснуть, решение принимает планировщик ОС. 
...
Так вот, первый поток проверяет, что указатель действительно на что-то ссылается, уже готов читать оттуда данные, но тут бам, ОС усыпила его и пробудила второй поток.
